...
const highlights: Highlight[] = [
  {
    ...
    name: `Chad's ${WhiteLabelConfig.AppName}`,
    founder: 'chad',
    founderAvatar: 'https://randomuser.me/api/portraits/men/33.jpg',
    bio: `This is a ${WhiteLabelConfig.AppName} bio that provides a preview of the group's mission and goals. The elements are clickable.`,
  },
  {
    ...
    bio: `Community outreach is my love language. This is the ${WhiteLabelConfig.AppName} bio. We'd love to have you`,
  },
  {
    ...
    <View style={{ paddingHorizontal: 16, paddingTop: 8, paddingBottom: 8 }}>
      <View style={{ marginBottom: 12 }}>
        <Text style={{ fontSize: 14, fontWeight: '600', color: '#111827' }}>
          ...
          <Text style={{ fontWeight: '400', color: PrimaryGrey }}>• In 6 {WhiteLabelConfig.AppName}</Text>
        </Text>
      </View>
      ...
      <View style={{ alignItems: 'flex-end', marginTop: 12 }}>
        <TouchableOpacity onPress={handleCreateCRWD}>
          <Text style={{ color: PrimaryBlue, fontSize: 14, fontWeight: '500' }}>
            Create a {WhiteLabelConfig.AppName}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
